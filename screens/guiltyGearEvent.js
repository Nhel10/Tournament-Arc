...
export default function GuiltyGearEvent({ navigation }) {
  var eventNameTemp = "Guilty Gear Event";
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          ...
          >
            <Image
              ...
              source={require("../assets/accentCore.jpg")}
            />
            <Text style={styles.item}>Guilty Gear Accent Core +r </Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            ...
            />
            <Text style={styles.item}>Guilty Gear Strive</Text>
          </View>
          <View style={styles.separator} />
        </ScrollView>
      </View>
