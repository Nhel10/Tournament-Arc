    ...
    <ScrollView style={globalStyles.container}>
      <Card style={style.eventCard}>
        <Card>
          ...
          ></Image>
          <Title style={style.eventTitle}>Planned Under Night Event 1</Title>
        </Card>
        ...
        <Card>
          ...
          ></Image>
          <Title style={style.eventTitle}>Planned Guilty Gear Event 2</Title>
          <Button
        ...
        <Card>
          ...
          ></Image>
          <Title style={style.eventTitle}>Planned Blazeblue Event 3</Title>
          <Button
