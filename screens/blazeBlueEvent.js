...
export default function GuiltyGearEvent({ navigation }) {
  var eventNameTemp = "BlazeBlue Event";
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          ...
          >
            <Image
              ...
              source={require("../assets/chrono.jpg")}
            />
            <Text style={styles.item}>Blazblue Chrono Phantasma </Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
