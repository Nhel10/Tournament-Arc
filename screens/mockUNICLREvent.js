...
export default function mockUNICLREvent({ navigation }) {
  var eventNameTemp = "CSULB Beach Con FGC Tournament";
  ...
  for (let i = 0; i < window.players.length; i++) {
    players.push(
      <View>
        ...
        >
          <UserButton
            username={window.players[i].username}
            img={window.players[i].image}
          ></UserButton>
        </View>
        <View style={styles.separator} />
      </View>
  ...
  for (let i = 0; i < window.cohosts.length; i++) {
    hosts.push(
      <View>
        ...
        >
          <UserButton
            username={window.cohosts[i].username}
            img={window.cohosts[i].image}
          ></UserButton>
        </View>
        <View style={styles.separator} />
      </View>
      ...
      <View style={styles.scrollViewHolder}>
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          ...
          >
            ...
            />
            <Text style={styles.item}>Street Fighter 5 </Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            ...
            />
            <Text style={styles.item}>Under Night UNICLR</Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            <Image
              style={styles.tinyLogo}
              source={require("../assets/mortal.jpg")}
            />
            <Text style={styles.item}>Mortal Kombat 11</Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            <Image
              style={styles.tinyLogo}
              source={require("../assets/tekken.png")}
            />
            <Text style={styles.item}>Tekken 7</Text>
          </View>
          <View style={styles.separator} />
        </ScrollView>
      </View>
