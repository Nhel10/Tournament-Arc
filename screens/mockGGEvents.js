...
export default function mockUGGSEvent({ navigation }) {
  var eventNameTemp = "ARC ARCREVO AMERICA 2019";
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          ...
          >
            <Image
              ...
              source={require("../assets/rev.jpg")}
            />
            <Text style={styles.item}>Guilty Gear Xrd rev 2 </Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            ...
            />
            <Text style={styles.item}>Blazblue Centralifiction</Text>
          </View>
          <View style={styles.separator} />
          <View
            style={{
          ...
          >
            <Image
              style={styles.tinyLogo}
              source={require("../assets/crosstag.png")}
            />
            <Text style={styles.item}>Blazeblue Cross Tag Battle</Text>
          </View>
          <View style={styles.separator} />
        </ScrollView>
      </View>
