...
class Registration extends Component {
  ...
  createAccount = (email, username, password) => {
    ...
    if (
      ...
      if (
        accounts.findIndex(
          (element) => element.email.toUpperCase() == email.toUpperCase()
        ) != -1
      )
        alert("This Email Address is Already in Use");
      else if (
        accounts.findIndex(
          (element) => element.username.toUpperCase() == username.toUpperCase()
        ) != -1
      )
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text}>{this.state.usernameCondition}</Text>
        ...
        <Text style={styles.text}>{this.state.passwordCondition}</Text>
