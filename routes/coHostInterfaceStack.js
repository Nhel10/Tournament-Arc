...
export const coHostInterfaceStack = () => (
  ...
  >
    <Tab.Screen name="Overview" component={coHostOverviewStack} />
    <Tab.Screen name="CheckIn" component={coHostCheckInStack} />
    <Tab.Screen name="Brackets" component={coHostBracketStack} />
  </Tab.Navigator>
);
