...
export const TournamentTopTab = () => (
  ...
  >
    <Tab.Screen name="Current Events" component={CurrentEventStack} />
    <Tab.Screen name="My Events" component={MyEventStack} />
    <Tab.Screen name="Create Event" component={CreateEventStack} />
    <Tab.Screen name="Past Events" component={PastEventStack} />
  </Tab.Navigator>
);
