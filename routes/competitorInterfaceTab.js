...
export const coHostInterfaceStack = () => (
  ...
  >
    <Tab.Screen name="Overview" component={CompOverviewStack} />
    <Tab.Screen name="CheckIn" component={CompCheckinStack} />
    <Tab.Screen name="List" component={checkListStack} />
    <Tab.Screen name="Unregistor" component={unregistor} />
  </Tab.Navigator>
);
